...
<html>
  <head>
    ...
    <title>TicketRoom - Technical Issues</title>
  </head>
  <body>
    <p class="m-t-20" style="text-align:center"><img src="{{ asset('images/logos/t_logo.png') }}" alt="TicketRoom Logo"></p>
    <h2 class="text-center">Looks Like We're Experiencing Some Technical Difficulties.</h2>
    <h2 class="text-center">Meanwhile...</h2>
    <br>
    <div class="row">
